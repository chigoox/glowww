...
// Provide a 'db' alias for convenience (some modules import { db })
const db = adminDb;
// Provide an 'auth' alias for convenience (some modules import { auth })
const auth = adminAuth;

export { adminDb, adminAuth, adminStorage, db, auth };
