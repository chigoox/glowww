...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section with Custom CSS Animations */}
      <section className="pt-24 pb-16 bg-gradient-to-br from-purple-50 via-white to-blue-50">
        <style jsx>{`
          ...
          .animate-slide-up { animation: slideUp 1s ease-out 0.2s forwards; opacity: 0; }
          .animate-slide-up-delayed { animation: slideUp 1s ease-out 0.4s forwards; opacity: 0; }
          .animate-fade-in-up { animation: fadeInUp 1.2s ease-out 0.6s forwards; opacity: 0; }
        `}</style>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="animate-fade-in text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6">
              Build Any Website
              <span className="block bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
                Without Code
              </span>
            </h1>
            <p className="animate-slide-up text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            ...
            <div className="animate-slide-up-delayed flex flex-col sm:flex-row gap-4 justify-center items-center">
              {!loading && (
                <>
                  {user ? (
                    <Link href="/Editor">
                      <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105">
                        Continue Building
                      </button>
                    </Link>
                  ) : (
              ...
              <button className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl text-lg font-semibold hover:border-purple-300 hover:text-purple-600 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                Watch Demo
              </button>
            </div>
          </div>

          {/* Interactive Web Editor Preview */}
          <div className="animate-fade-in-up mt-20 relative">
              ...
              <div className="bg-gray-50 rounded-2xl p-2 mb-4 border border-gray-200">
                <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-sm text-gray-600 font-medium">Glow Website Builder</div>
                  </div>
                  <div className="flex items-center space-x-2 text-xs text-gray-500">
                    <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded-full font-medium">Live Preview</span>
                  </div>
                </div>
              </div>
                ...
                <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
                  <div className="p-4 border-b border-gray-200">
                    ...
                    <div className="space-y-4">
                      {/* Layout Components */}
                      <div>
                        <div className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-2">Layout</div>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="group cursor-pointer p-3 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 hover:shadow-md">
                            ...
                            <div className="text-xs text-center text-gray-700 group-hover:text-purple-700">Box</div>
                          </div>
                          <div className="group cursor-pointer p-3 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 hover:shadow-md">
                            ...
                            <div className="text-xs text-center text-gray-700 group-hover:text-purple-700">Grid</div>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Content Components */}
                      <div>
                        <div className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-2">Content</div>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="group cursor-pointer p-3 border border-gray-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition-all duration-200 hover:shadow-md">
                            ...
                            <div className="text-xs text-center text-gray-700 group-hover:text-green-700">Text</div>
                          </div>
                          <div className="group cursor-pointer p-3 border border-gray-200 rounded-lg hover:border-orange-300 hover:bg-orange-50 transition-all duration-200 hover:shadow-md">
                            ...
                            <div className="text-xs text-center text-gray-700 group-hover:text-orange-700">Image</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-2">Interactive</div>
                        <div className="group cursor-pointer p-3 border border-gray-200 rounded-lg hover:border-pink-300 hover:bg-pink-50 transition-all duration-200 hover:shadow-md">
                          ...
                          <div className="text-xs text-center text-gray-700 group-hover:text-pink-700">Button</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="max-w-4xl mx-auto space-y-8">
                      ...
                      <div className="group relative p-6 bg-white rounded-xl border-2 border-dashed border-gray-200 hover:border-purple-300 transition-all duration-300 hover:shadow-lg cursor-pointer">
                        <div className="absolute -top-2 -right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                          <div className="bg-purple-600 text-white px-2 py-1 rounded text-xs font-medium">Edit Header</div>
                        </div>
                        <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to My Site</h1>
                        <p className="text-xl text-gray-600">This is a sample website being built in real-time</p>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="group relative p-6 bg-gradient-to-br from-blue-50 to-white rounded-xl border-2 border-dashed border-gray-200 hover:border-blue-300 transition-all duration-300 hover:shadow-lg cursor-pointer">
                          <div className="absolute -top-2 -right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                            <div className="bg-blue-600 text-white px-2 py-1 rounded text-xs font-medium">Edit Box</div>
                          </div>
                          <h3 className="text-2xl font-semibold mb-4">About Us</h3>
                          <p className="text-gray-600">We create amazing experiences through innovative design and technology.</p>
                        </div>
                        ...
                        <div className="group relative p-6 bg-gradient-to-br from-green-50 to-white rounded-xl border-2 border-dashed border-gray-200 hover:border-green-300 transition-all duration-300 hover:shadow-lg cursor-pointer">
                          <div className="absolute -top-2 -right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                            <div className="bg-green-600 text-white px-2 py-1 rounded text-xs font-medium">Edit Image</div>
                          </div>
                          ...
                          <p className="text-sm text-gray-600">Sample image placeholder</p>
                        </div>
                      </div>
                      ...
                      <div className="group relative text-center">
                        <div className="inline-block relative">
                          <div className="absolute -top-2 -right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10">
                            <div className="bg-pink-600 text-white px-2 py-1 rounded text-xs font-medium">Edit Button</div>
                          </div>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group bg-gradient-to-br from-purple-50 to-white p-8 rounded-2xl border border-purple-100 hover:shadow-xl hover:shadow-purple-100 transition-all duration-500 hover:-translate-y-2 transform">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-purple-700 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM21 5a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a4 4 0 004 4h4a2 2 0 002-2V5z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-purple-700 transition-colors duration-300">Visual Drag & Drop</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                Build websites intuitively by dragging and dropping elements exactly where you want them. No coding knowledge required.
              </p>
              <ul className="text-sm text-gray-500 space-y-2">
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-purple-500 rounded-full mr-2"></span>Real-time visual feedback</li>
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-purple-500 rounded-full mr-2"></span>Smart snap-to-grid alignment</li>
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-purple-500 rounded-full mr-2"></span>Undo/redo capabilities</li>
              </ul>
            </div>

            {/* Feature 2 */}
            <div className="group bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl border border-blue-100 hover:shadow-xl hover:shadow-blue-100 transition-all duration-500 hover:-translate-y-2 transform">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-700 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-blue-700 transition-colors duration-300">Mobile-First Design</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                Every website automatically works perfectly on all devices. Our responsive design system ensures your site looks amazing everywhere.
              </p>
              <ul className="text-sm text-gray-500 space-y-2">
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Automatic responsive breakpoints</li>
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Touch-friendly interface</li>
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>Cross-browser compatibility</li>
              </ul>
            </div>

            {/* Feature 3 */}
            <div className="group bg-gradient-to-br from-green-50 to-white p-8 rounded-2xl border border-green-100 hover:shadow-xl hover:shadow-green-100 transition-all duration-500 hover:-translate-y-2 transform">
              <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-green-700 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-green-700 transition-colors duration-300">Lightning Fast</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                Optimized performance and clean code generation ensures your websites load quickly and rank well in search engines.
              </p>
              <ul className="text-sm text-gray-500 space-y-2">
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>Optimized image delivery</li>
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>Clean, semantic code</li>
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>Global CDN hosting</li>
              </ul>
            </div>
          </div>
        </div>
